...
export default (props) => {
    ...
    const [startDate, setStartDate] = useState(props.request.effectiveStartDate)

    const [endDate, setEndDate] = useState(props.request.effectiveEndDate)
    ...
    const darkTheme = createTheme({
      ...
      useEffect(() => {
        props.onUpdateEffectiveDates(startDate, endDate)
      }, [startDate, endDate]);

    return (
        <>
            <p>Please specify the effective date range</p>
